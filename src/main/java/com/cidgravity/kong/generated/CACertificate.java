...
public class CACertificate {
    ...
    public CACertificate withCert_digest(String cert_digest) {
        this.cert_digest = cert_digest;
        return this;
    }
    ...
    public CACertificate withCreated_at(Integer created_at) {
        this.created_at = created_at;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CACertificate.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
                .append('[');
        sb.append("cert");
        sb.append('=');
